				...
				<body>
					<div class="sitemap-container">
						...
						<?php if ( ! $crons_available ) { ?>
							<p>[NOTE] It seems CRON is not enabled on your site. You can use the <a href="<?php echo esc_url( admin_url( 'admin.php?page=surerank#/advanced/sitemaps' ) ); ?>">Regenerate</a> button to generate the sitemap cache manually.</p>
						<?php } ?>
					</div>	
